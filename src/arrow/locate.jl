...
module Locate
    import ..ArrowCompat
    using ..ArrowCompat: ALIGNMENT, DefaultOffset
    ...
    containertype(::Type{J}, v) where {J} = ArrowCompat.Primitive
    containertype(::Type{Union{J,Missing}}, v) where {J} = ArrowCompat.NullablePrimitive
    containertype(::Type{String}, v) = ArrowCompat.List
    containertype(::Type{Union{String,Missing}}, v) = ArrowCompat.NullableList
    containertype(::Type{Bool}, v) = ArrowCompat.BitPrimitive
    containertype(::Type{Union{Bool,Missing}}, v) = ArrowCompat.NullableBitPrimitive
